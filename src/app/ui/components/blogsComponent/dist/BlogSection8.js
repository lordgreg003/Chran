        ...
        React.createElement("div", { id: "blogLayout", className: "grid grid-cols-1 md:grid-cols-3 gap-8 " + (isVisible ? 'animate__animated animate__zoomIn' : '') },
            React.createElement("div", { className: "md:col-span-2" },
                React.createElement("div", { className: "relative" },
                    React.createElement(link_1["default"], { href: "/blo/detail8/" + data4_1.mainCardData6.slug },
                        React.createElement(image_1["default"], { src: data4_1.mainCardData6.imageSrc, alt: data4_1.mainCardData6.title, width: 400, height: 200, className: "w-full h-auto rounded cursor-pointer" })),
                ...
                React.createElement("h2", { className: fonts_1.playfair_Display.className + " mt-4 text-2xl font-semibold" },
                    React.createElement(link_1["default"], { href: "/blo/detail8/" + data4_1.mainCardData6.slug, className: "cursor-pointer" }, data4_1.mainCardData6.title)),
                React.createElement("p", { className: fonts_1.open_sans.className + " mt-2 text-gray-600" },
                    React.createElement(link_1["default"], { href: "/blo/detail8/" + data4_1.mainCardData6.slug, className: "cursor-pointer" }, data4_1.mainCardData6.description)),
                React.createElement("div", { className: "mt-4 flex items-center gap-4" },
                    React.createElement("span", { className: fonts_1.open_sans.className + " text-sm text-gray-500" }, data4_1.mainCardData6.articleCount),
                    React.createElement("button", { className: "px-3 py-1 border border-gray-300 text-sm rounded" }, data4_1.mainCardData6.category))))));
}
exports["default"] = BlogLayout8;
