  ...
  return cardData
    ? {
        ...
        openGraph: {
          ...
          images: [
            {
              url: cardData.imageSrc || "https://res.cloudinary.com/dg8cmo2gb/image/upload/v1738127372/WhatsApp_Image_2025-01-28_at_2.43.56_PM_edezpm.jpg",
              width: 800,
              height: 600,
              alt: cardData.title,
            },
    ...
    return (
      <div className="max-w-screen-xl mx-auto overflow-x-hidden py-8 px-4">
       ...
       <div className="md:flex md:flex-row gap-2"> <div className="flex flex-col   gap-12 md:w-[79%]">
        <div className="mt-6 space-y-10 space-x-0 w-full lg:flex lg:space-y-0 lg:space-x-10 ">
           <Image
