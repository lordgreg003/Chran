  ...
  return (
    <div className="p-4 flex flex-col space-y-6 md:w-full lg:w-3/4 xl:w-2/3 mx-auto">
      ...
      <div className="bg-white dark:bg-[#1E1E1E] p-6 rounded-lg shadow-lg w-full">
        ...
        {[
          { key: "image1", image: image1, preview: preview1, setImage: setImage1, setPreview: setPreview1 },
          { key: "image2", image: image2, preview: preview2, setImage: setImage2, setPreview: setPreview2 },
          { key: "image3", image: image3, preview: preview3, setImage: setImage3, setPreview: setPreview3 },
          { key: "image4", image: image4, preview: preview4, setImage: setImage4, setPreview: setPreview4 },
          { key: "image5", image: image5, preview: preview5, setImage: setImage5, setPreview: setPreview5 },
        ].map(({ key, preview, setImage, setPreview }) => (
            ...
            <label htmlFor={key} className="cursor-pointer">
              {preview ? (
                <div className="relative">
                  ...
                  />
                  <button
                    onClick={() => removePreview(setImage, setPreview)}
