...
import { data} from "@/app/ui/data/data3";
import { open_sans, playfair_Display } from "@/app/ui/fonts/fonts";
import {  mainCardData6 } from "@/app/ui/data/data4";


// Simulate fetching data from mainCardData2
async function getData(slug: string): Promise<data | undefined> {
    return new Promise((resolve, reject) => {
        if (mainCardData6.slug === slug) {
          resolve(mainCardData6);
        } else {
  ...
  return cardData
    ? {
        ...
        openGraph: {
          ...
          images: [
            {
              url: cardData.imageSrc || "https://res.cloudinary.com/dg8cmo2gb/image/upload/v1738683880/WhatsApp_Image_2025-02-04_at_4.40.39_PM_1_q17itu.jpg",
              width: 800,
              height: 600,
              alt: cardData.title,
            },
